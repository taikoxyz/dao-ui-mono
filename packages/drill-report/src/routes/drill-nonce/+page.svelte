...
<div class="container mx-auto p-8">
  ...
  <nav class="text-sm mb-4">
    <ol class="flex items-center space-x-2">
      <li><a href="/" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Home</a></li>
      <li><span class="text-gray-500 dark:text-gray-400">/</span></li>
      <li class="text-gray-700 dark:text-gray-300">Drill Explorer</li>
    </ol>
  </nav>

  <!-- Contract Info Card -->
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl mb-6 p-6">
    <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Contract Information</h2>
    
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
        <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">Contract Address</div>
        <code class="text-xs break-all text-gray-900 dark:text-gray-100">{config.contracts.SecurityCouncilDrill}</code>
      </div>
      <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
        <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">RPC Endpoint</div>
        <code class="text-xs break-all text-gray-900 dark:text-gray-100">{config.urls.rpc}</code>
      </div>
    </div>
  </div>
