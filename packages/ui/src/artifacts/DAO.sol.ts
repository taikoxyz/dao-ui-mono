export const DaoAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_who", type: "address", internalType: "address" },
      { name: "_permissionId", type: "bytes32", internalType: "bytes32" },
      { name: "_condition", type: "address", internalType: "contract IPermissionCondition" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    name: "initializeFrom",
    inputs: [
      { name: "_previousProtocolVersion", type: "uint8[3]", internalType: "uint8[3]" },
  ...
  },
  {
    ...
    inputs: [{ name: "_signatureValidator", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [{ name: "_newTrustedForwarder", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "contract IERC1271" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "sig", type: "bytes4", indexed: true, internalType: "bytes4" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_reference", type: "string", indexed: false, internalType: "string" },
    ],
    anonymous: false,
  },
  {
    ...
    inputs: [
      ...
      { name: "callId", type: "bytes32", indexed: false, internalType: "bytes32" },
      {
        name: "actions",
        type: "tuple[]",
        indexed: false,
      ...
      { name: "execResults", type: "bytes[]", indexed: false, internalType: "bytes[]" },
    ],
    anonymous: false,
  },
  {
    ...
    name: "Granted",
    inputs: [
      { name: "permissionId", type: "bytes32", indexed: true, internalType: "bytes32" },
      { name: "here", type: "address", indexed: true, internalType: "address" },
      { name: "where", type: "address", indexed: false, internalType: "address" },
      { name: "who", type: "address", indexed: true, internalType: "address" },
      { name: "condition", type: "address", indexed: false, internalType: "address" },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    type: "event",
    name: "NewURI",
    inputs: [{ name: "daoURI", type: "string", indexed: false, internalType: "string" }],
    anonymous: false,
  },
  {
    type: "event",
  ...
  },
  {
    ...
    inputs: [{ name: "signatureValidator", type: "address", indexed: false, internalType: "address" }],
    anonymous: false,
  },
  {
    type: "event",
    ...
    inputs: [
      ...
      { name: "callbackSelector", type: "bytes4", indexed: false, internalType: "bytes4" },
  ...
  },
  {
    ...
    inputs: [{ name: "forwarder", type: "address", indexed: false, internalType: "address" }],
    anonymous: false,
  },
  {
    type: "event",
  ...
  { type: "error", name: "ActionFailed", inputs: [{ name: "index", type: "uint256", internalType: "uint256" }] },
  { type: "error", name: "AnyAddressDisallowedForWhoAndWhere", inputs: [] },
  {
    type: "error",
    name: "ConditionInterfacNotSupported",
    inputs: [{ name: "condition", type: "address", internalType: "contract IPermissionCondition" }],
  },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "who", type: "address", internalType: "address" },
      { name: "permissionId", type: "bytes32", internalType: "bytes32" },
      { name: "currentCondition", type: "address", internalType: "address" },
      { name: "newCondition", type: "address", internalType: "address" },
    ],
  },
  { type: "error", name: "PermissionsForAnyAddressDisallowed", inputs: [] },
  {
    type: "error",
    name: "ProtocolVersionUpgradeNotSupported",
    inputs: [{ name: "protocolVersion", type: "uint8[3]", internalType: "uint8[3]" }],
  },
