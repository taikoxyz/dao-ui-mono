import { AvatarIcon, Heading, IconType, ProposalStatus } from "@aragon/ods";
...
const ProposalHeader: React.FC<ProposalHeaderProps> = ({ proposalId, proposal }) => {
  ...
  const profileAddress = owner ?? creator;
  const profile = profileAddress ? getSecurityCouncilProfile(profileAddress) : undefined;
