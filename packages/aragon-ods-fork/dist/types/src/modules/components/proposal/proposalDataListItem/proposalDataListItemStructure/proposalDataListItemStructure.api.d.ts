...
export interface IProposalDataListItemStructureBaseProps<TType extends ProposalType = ProposalType> extends IDataListItemProps, IWeb3ComponentProps {
    /**
     * Proposal id
     */
    id?: string;
...
export type IProposalDataListItemStructureProps = IProposalDataListItemStructureBaseProps<'majorityVoting'> | IProposalDataListItemStructureBaseProps<'approvalThreshold'>;
